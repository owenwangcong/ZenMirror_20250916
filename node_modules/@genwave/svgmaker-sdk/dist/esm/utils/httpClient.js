...
import { TimeoutError, NetworkError, APIError, AuthError, RateLimitError, InsufficientCreditsError, ContentSafetyError, FileSizeError, FileFormatError, } from '../errors/CustomErrors';
/**
...
export class HttpClient {
    ...
    async handleErrorResponse(response) {
        ...
        switch (response.status) {
            ...
            case 429:
                return new RateLimitError(message, parseInt(response.headers.get('Retry-After') || '60', 10));
        }
        ...
        // Generic API error
        return new APIError(message, response.status, errorData.errorType || errorData.error_type, errorData.details);
    }
}
