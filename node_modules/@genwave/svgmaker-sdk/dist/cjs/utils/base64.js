...
exports.decodeBase64SvgText = decodeBase64SvgText;
exports.decodeSvgContent = decodeSvgContent;
exports.decodeBase64Png = decodeBase64Png;
exports.isSvgContent = isSvgContent;
/**
 * Decode a base64-encoded SVG text to a UTF-8 string
 * @param base64 Base64-encoded SVG
 * @returns Decoded SVG string
 */
function decodeBase64SvgText(base64) {
    try {
 ...
 */
function decodeSvgContent(svgContent) {
