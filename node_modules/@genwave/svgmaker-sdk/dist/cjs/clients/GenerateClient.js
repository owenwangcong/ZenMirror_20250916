 ...
 */
const generateParamsSchema = zod_1.z
    .object({
    prompt: zod_1.z.string().min(1, 'Prompt is required'),
    quality: zod_1.z.enum(['low', 'medium', 'high']).optional(),
    aspectRatio: zod_1.z.enum(['auto', 'portrait', 'landscape', 'square', 'wide', 'tall']).optional(),
 ...
 */
class GenerateClient extends BaseClient_1.BaseClient {
    /**
