 ...
 */
const convertParamsSchema = zod_1.z.object({
    file: zod_1.z.union([zod_1.z.string(), zod_1.z.instanceof(Buffer), zod_1.z.instanceof(stream_1.Readable)]),
 ...
 */
class ConvertClient extends BaseClient_1.BaseClient {
    /**
    ...
    async execute() {
        ...
        if (result.svgText && typeof result.svgText === 'string') {
            result.svgText = (0, base64_1.decodeSvgContent)(result.svgText);
        }
        return result;
    }
    /**
...
//# sourceMappingURL=ConvertClient.js.map